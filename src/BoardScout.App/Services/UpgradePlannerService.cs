...
internal static class UpgradePlannerService
{
    ...
    public static string GenerateReport(ScanManifest scan)
    {
        ...
        sb.AppendLine($"<p>Generated by <a href='https://github.com/mikedopp/BoardScout'>BoardScout</a> v{UI.VersionButton.AppVersion} · {DateTime.Now:MMMM d, yyyy}</p>");
        sb.AppendLine("<p>All product names are trademarks of their respective owners. " +
                      "Prices are estimates based on US market research (August 2026) and are not offers to sell.</p>");
        sb.AppendLine("<p>DDR4 and legacy AM4 parts have inflated pricing due to global DRAM shortages " +
                      "and AM4 platform discontinuation. No affiliation with any hardware vendor.</p>");
        sb.AppendLine("<p>Sources: Tom's Hardware · Pangoly · GPU Prix · Pangoly DDR4 · Neowin</p>");
        sb.AppendLine("</div>");
        sb.AppendLine("<div class='footer-brand'>BoardScout</div>");
        sb.AppendLine("</div>");
    ...
    private static string ReportCss() => """
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .footer { margin-top: 48px; padding-top: 16px; border-top: 1px solid #162030; font-size: 11px; color: #5A6B82; display: flex; align-items: flex-end; justify-content: space-between; gap: 32px; }
        .footer-left { flex: 1; }
        .footer-left p { margin-bottom: 4px; }
        .footer-left a { color: #3D9EFF; text-decoration: underline; }
        .footer-brand { font-family: 'Segoe UI Black', 'Segoe UI', system-ui, sans-serif; font-size: 28px; font-weight: 900; color: #3D9EFF; white-space: nowrap; letter-spacing: -0.5px; opacity: 0.7; }
